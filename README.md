...
```sh
# locally
pnpm install -D @modyqyw/fabric@~4.9.0

# globally
pnpm install -g @modyqyw/fabric@~4.9.0
```
...
```sh
pnpm install -D eslint@~8.7.0 @babel/core@~7.16.10 @babel/eslint-parser@~7.16.5
```
...
```sh
pnpm install -D stylelint@~14.2.0
```
