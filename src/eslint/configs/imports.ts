  ...
  return [
    {
      ...
      rules: {
        ...
        // https://github.com/un-ts/eslint-plugin-import-x/blob/v4.4.0/docs/rules/no-named-as-default.md
        "import/no-named-as-default": "warn",

        // https://github.com/un-ts/eslint-plugin-import-x/blob/v4.4.0/docs/rules/no-named-as-default-member.md
        "import/no-named-as-default-member": "warn",

        // https://github.com/un-ts/eslint-plugin-import-x/blob/v4.4.0/docs/rules/default.md
        "import/default": "error",

        // https://github.com/un-ts/eslint-plugin-import-x/blob/v4.4.0/docs/rules/named.md
        "import/named": "error",

        // https://github.com/un-ts/eslint-plugin-import-x/blob/v4.4.0/docs/rules/namespace.md
        "import/namespace": "error",

        // https://github.com/un-ts/eslint-plugin-import-x/blob/v4.4.0/docs/rules/no-self-import.md
        "import/no-self-import": "error",

        // https://github.com/un-ts/eslint-plugin-import-x/blob/v4.4.0/docs/rules/no-duplicates.md
        "import/no-duplicates": "warn",

        // https://github.com/un-ts/eslint-plugin-import-x/blob/v4.4.0/docs/rules/no-unresolved.md
        ...
        // https://github.com/un-ts/eslint-plugin-import-x/blob/v4.4.0/docs/rules/order.md
        "import/order": [
          "error",
          {
            groups: [
