import { GLOB_JSON, GLOB_JSON5, GLOB_JSONC } from "../../constants.ts";
import { parserJsonc, pluginJsonc, pluginPackageJson } from "../plugins.ts";
import type { Config, JsoncOptions } from "../types.ts";
