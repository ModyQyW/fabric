  ...
  return [
    {
      ...
      rules: {
        // https://github.com/typescript-eslint/typescript-eslint/blob/v8.3.0/packages/eslint-plugin/src/configs/eslint-recommended-raw.ts
        ...
        // https://github.com/typescript-eslint/typescript-eslint/blob/v8.3.0/packages/eslint-plugin/src/configs/recommended.ts
        ...
        // https://github.com/typescript-eslint/typescript-eslint/blob/v8.3.0/packages/eslint-plugin/src/configs/recommended-type-checked-only.ts
        ...(typeCheck
          ? {
