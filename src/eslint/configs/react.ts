  ...
  return [
    {
      ...
      rules: {
        // https://github.com/Rel1cx/eslint-react/blob/v1.14.3/packages/plugins/eslint-plugin-react-x/README.md
        ...
        // https://github.com/Rel1cx/eslint-react/blob/v1.14.3/packages/plugins/eslint-plugin-react-dom/README.md
        ...
        // https://github.com/Rel1cx/eslint-react/blob/v1.14.3/packages/plugins/eslint-plugin-react-web-api/README.md
        "react-web-api/no-leaked-timeout": "error",
        "react-web-api/no-leaked-interval": "error",
        "react-web-api/no-leaked-event-listener": "error",
        "react-web-api/no-leaked-resize-observer": "error",

        // https://github.com/Rel1cx/eslint-react/blob/v1.14.3/packages/plugins/eslint-plugin-react-hooks-extra/README.md
        "react-hooks-extra/no-redundant-custom-hook": "warn",
        "react-hooks-extra/no-direct-set-state-in-use-effect": "warn",
        "react-hooks-extra/prefer-use-state-lazy-initialization": "warn",

        // https://github.com/Rel1cx/eslint-react/blob/v1.14.3/packages/plugins/eslint-plugin-react-naming-convention/README.md
